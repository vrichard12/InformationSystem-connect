...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.interaction.ParameterValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterValueItemProvider extends ObeoDSMObjectItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParameterValue_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterValue_name_feature", "_UI_ParameterValue_type"),
				 InteractionPackage.Literals.PARAMETER_VALUE__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ParameterValue.class)) {
			case InteractionPackage.PARAMETER_VALUE__NAME:
