...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.object.Value} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueItemProvider extends IdentifiableItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Value_metaType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Value_metaType_feature", "_UI_Value_type"),
				 ObjectPackage.Literals.VALUE__META_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Value)object).getTechnicalid();
	...
	public ResourceLocator getResourceLocator() {
		return ObjectEditPlugin.INSTANCE;
	}
