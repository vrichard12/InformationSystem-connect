...
public class WorkspaceImpl extends ObeoDSMObjectImpl implements Workspace {
	...
	protected EClass eStaticClass() {
		return ObjectPackage.Literals.WORKSPACE;
	}
	...
	public EList<Value> getValues() {
		return (EList<Value>)eDynamicGet(ObjectPackage.WORKSPACE__VALUES, ObjectPackage.Literals.WORKSPACE__VALUES, true, true);
	}
